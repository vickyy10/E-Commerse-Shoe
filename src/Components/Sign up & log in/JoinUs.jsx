...
const JoinUs = () => {
  ...
  return (
    ...
    <form ref={inputref} onSubmit={submitHandler}>
       <div className='heading-div contaier ' ><h3 className='heading'  >sign up</h3> <img onClick={()=>nav('/')} className='x-icon' style={{height:"40px",right:"13px",position:"absolute"}} src="https://cdn-icons-png.flaticon.com/128/7543/7543146.png" alt="" /></div>
